...
class MassiveClient:
    ...
    def get_sp_1500_symbols(self) -> List[str]:
        """
        Get S&P 1500 stock symbols (S&P 500 + MidCap 400 + SmallCap 600)
        This provides comprehensive US stock market coverage
        """
        # Start with S&P 500
        sp500 = self.get_sp500_symbols()
        
        # S&P MidCap 400 (representative sample - full list would be 400 symbols)
        # These are stocks with market caps roughly $3B-$14B
        midcap_400 = [
            # Technology
            'DOCU', 'ZM', 'BILL', 'TENB', 'ZI', 'GTLB', 'PATH', 'DOCN', 'FROG', 'APPF',
            
            # Healthcare
            'PTCT', 'TMDX', 'GKOS', 'PRVA', 'KRYS', 'NTRA', 'RVMD', 'PRTA', 'SAGE', 'SWTX',
            
            # Financials  
            'SFNC', 'CADE', 'WTFC', 'UBSI', 'BPOP', 'OZK', 'SFBS', 'WAFD', 'FCNCA', 'UMBF',
            
            # Consumer
            'TXRH', 'WING', 'SHAK', 'CHUY', 'BJRI', 'CAKE', 'BLMN', 'CBRL', 'DIN', 'EAT',
            
            # Industrials
            'ARCB', 'SAIA', 'CVCO', 'WERN', 'MATX', 'HUBG', 'KNX', 'ALK', 'JBLU', 'SAVE'
        ]
        
        # S&P SmallCap 600 (representative sample)
        # These are stocks with market caps roughly $850M-$3.6B  
        smallcap_600 = [
            # Technology
            'SPSC', 'ARLO', 'PRGS', 'ALRM', 'AMBA', 'SMTC', 'CALX', 'VIAV', 'EXLS', 'POWI',
            
            # Healthcare
            'TNDM', 'NVAX', 'LNTH', 'PDCO', 'TRUP', 'OMCL', 'ICUI', 'ATRC', 'STAA', 'NEOG',
            
            # Financials
            'NYCB', 'SBNY', 'PACW', 'WAL', 'SMBK', 'HTLF', 'AROW', 'CATY', 'CVBF', 'ESSA',
            
            # Consumer
            'CEIX', 'SM', 'GPI', 'SCSC', 'PLAY', 'PRTY', 'DDS', 'WRLD', 'HIBB', 'UNFI',
            
            # Energy
            'AR', 'CRK', 'MTDR', 'MGY', 'GPOR', 'CPE', 'VTLE', 'MNRL', 'ESTE', 'REI'
        ]

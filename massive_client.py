...
class MassiveClient:
    ...
    def get_major_etfs(self) -> List[str]:
        """Major ETF symbols"""
        return ['SPY','QQQ','DJI','IWM','VOO','VTI','IVV','VEA','IEFA','XLE','XLF','XLK','XLV','XLI','XLP','XLY','XLU','XLB','XLRE','XLC','VGT','VIG','VNQ','VWO','VT','EEM','EFA','AGG','BND','LQD','HYG','GLD','SLV','USO','UNG','DBC','CORN','WEAT','SOYB','GDX','IBIT','ETHA','SIL','CPER','PPLT','PALL','UGA','URNM','URA','COPX','SRUU']

...
CRYPTO_LIMIT = 100  # Top 100 crypto from CryptoCompare

# Stock Loading Strategy  
# Set to True to load S&P 1500 (500 + MidCap 400 + SmallCap 600)
# Set to False to load only S&P 500
USE_SP1500 = True  # COMPLETE 1,500 stocks - background processing handles it
